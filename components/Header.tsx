      ...
      <div className="flex items-center space-x-5">
        <Link href="/">
          <div className="border-solid border-2 border-rose-600 p-1 cursor-pointer ">
            <div className="bg-rose-600 p-2 text-center w-20 md:w-44">
              <p className="text-white font-serif text-xl md:text-2xl leading-none font-light">
                RIVER WALK
              </p>
            </div>
          </div>
        </Link>
        <div className="hidden md:inline-flex items-center space-x-1 md:space-x-5">
          {/* [&>*]:m-4 [&>*]:mt-2" */}
          <Link href="">
            <a>About</a>
          </Link>
